...
constexpr inline std::uint16_t half_mul(std::uint16_t x, std::uint16_t y) noexcept {
  ...
  const std::uint32_t c_m_norm_lo_nlz =
      half_private::_uint16_cntlz(static_cast<uint16_t>(c_m_norm_lo));
  ...
  const std::uint32_t c_m_normalized =
      half_private::_uint32_sels(is_c_m_norm_no_hidden_msb, c_m_hidden, c_m_norm_radix_corrected);
  const std::uint32_t c_e_normalized =
      half_private::_uint32_sels(is_c_m_norm_no_hidden_msb, c_e_hidden, c_e_norm_radix_corrected);
...
struct float16_t {
  ...
  constexpr inline float16_t(float other) noexcept
      : data_{float16_t_private::float32_to_float16(other)} {}
  constexpr inline float16_t(double other) noexcept
      : data_{float16_t_private::float32_to_float16(static_cast<float>(other))} {}
  constexpr inline float16_t(std::integral auto other) noexcept
      : data_{float16_t_private::float32_to_float16(static_cast<float>(other))} {}
  constexpr inline float16_t(unsafe_t, std::uint16_t bits) noexcept : data_{bits} {}
...
constexpr inline float16_t fp16_infinity{unsafe, static_cast<std::uint16_t>(0x7c00)};
constexpr inline float16_t fp16_max(unsafe, static_cast<std::uint16_t>(0x7bff));  // 65504
constexpr inline float16_t fp16_max_subnormal{unsafe,
                                              static_cast<std::uint16_t>(0x3ff)};  // 0.00006097
constexpr inline float16_t fp16_min{unsafe, static_cast<std::uint16_t>(0xfbff)};
constexpr inline float16_t fp16_min_positive{unsafe, static_cast<std::uint16_t>(0x400)};
constexpr inline float16_t fp16_min_positive_subnormal{unsafe, static_cast<std::uint16_t>(0x1)};
constexpr inline float16_t fp16_nan{unsafe, static_cast<std::uint16_t>(0x7e00)};
constexpr inline float16_t fp16_infinity_negative{unsafe, static_cast<std::uint16_t>(0xfc00)};
constexpr inline float16_t fp16_epsilon{unsafe, static_cast<std::uint16_t>(0x1400)};

constexpr inline float16_t fp16_one{unsafe, static_cast<std::uint16_t>(0x3c00)};
constexpr inline float16_t fp16_one_negative{unsafe, static_cast<std::uint16_t>(0x4000)};
constexpr inline float16_t fp16_two{unsafe, static_cast<std::uint16_t>(0x4000)};
constexpr inline float16_t fp16_two_negative{unsafe, static_cast<std::uint16_t>(0xc000)};
constexpr inline float16_t fp16_half{unsafe, static_cast<std::uint16_t>(0x3800)};
constexpr inline float16_t fp16_half_negative{unsafe, static_cast<std::uint16_t>(0x3b00)};
constexpr inline float16_t fp16_zero{unsafe, static_cast<std::uint16_t>(0x0)};
constexpr inline float16_t fp16_zero_negative{unsafe, static_cast<std::uint16_t>(0x8000)};
constexpr inline float16_t fp16_e{unsafe, static_cast<std::uint16_t>(0x4170)};
constexpr inline float16_t fp16_pi{unsafe, static_cast<std::uint16_t>(0x4248)};
...
constexpr inline bool operator<(float16_t lhs, float16_t rhs) noexcept {
  ...
  if (l_ieee.sign_ == 1) {
    if (r_ieee.sign_ == 0)
      return true;
    if (l_ieee.exp_ > r_ieee.exp_)
      return true;
    if (l_ieee.exp_ < r_ieee.exp_)
      return false;
    if (l_ieee.frac_ > r_ieee.frac_)
      return true;
    return false;
  }
...
auto constexpr inline make_unary_function = [](auto const& func) noexcept {
  return [func](float16_t f) -> float16_t {
    return func(float(f));
  };
};
...
auto constexpr inline make_trinary_function = [](auto const& func) noexcept {
  return [func](float16_t f1, float16_t f2, float16_t f3) -> float16_t {
    return func(float(f1), float(f2), float(f3));
  };
};

}  // namespace float16_t_private

// constexpr inline auto fmod = float16_t_private::make_binary_function( []( float f1, float f2 ) {
// return std::fmod( f1, f2 ); } ); constexpr inline auto remainder =
// float16_t_private::make_binary_function( []( float f1, float f2 ) { return std::remainder( f1, f2
// ); } );

// constexpr inline auto fma = float16_t_private::make_trinary_function( []( float f1, float f2,
// float f3 ) { return std::fma( f1, f2, f3 ); } ); constexpr inline auto fmax =
// float16_t_private::make_binary_function( []( float f1, float f2 ) { return std::fmax( f1, f2 ); }
// ); constexpr inline auto fmin = float16_t_private::make_binary_function( []( float f1, float f2 )
// { return std::fmax( f1, f2 ); } ); constexpr inline auto fdim =
// float16_t_private::make_binary_function( []( float f1, float f2 ) { return std::fdim( f1, f2 ); }
// ); constexpr inline auto lerp = float16_t_private::make_trinary_function( []( float f1, float f2,
// float f3 ) { return f1 + f3 * (f2 - f1); } ); constexpr inline auto exp =
// float16_t_private::make_unary_function( [](float f){ return std::exp(f); } ); constexpr inline
// auto exp2 = float16_t_private::make_unary_function( [](float f){ return std::exp2(f); } );
// constexpr inline auto expm1 = float16_t_private::make_unary_function( [](float f){ return
// std::expm1(f); } ); constexpr inline auto log = float16_t_private::make_unary_function( [](float
// f){ return std::log(f); } ); constexpr inline auto log10 =
// float16_t_private::make_unary_function( [](float f){ return std::log10(f); } ); constexpr inline
// auto log2 = float16_t_private::make_unary_function( [](float f){ return std::log2(f); } );
// constexpr inline auto log1p = float16_t_private::make_unary_function( [](float f){ return
// std::log1p(f); } ); constexpr inline auto pow = float16_t_private::make_binary_function( [](
// float f1, float f2 ) { return std::pow( f1, f2 ); } ); constexpr inline auto sqrt =
// float16_t_private::make_unary_function( [](float f){ return std::sqrt(f); } ); constexpr inline
// auto cbrt = float16_t_private::make_unary_function( [](float f){ return std::cbrt(f); } );
...
// constexpr inline auto sin = float16_t_private::make_unary_function( [](float f){ return
// std::sin(f); } ); constexpr inline auto sinh = float16_t_private::make_unary_function( [](float
// f){ return std::sinh(f); } ); constexpr inline auto cos = float16_t_private::make_unary_function(
// [](float f){ return std::cos(f); } ); constexpr inline auto cosh =
// float16_t_private::make_unary_function( [](float f){ return std::cosh(f); } ); constexpr inline
// auto tan = float16_t_private::make_unary_function( [](float f){ return std::tan(f); } );
// constexpr inline auto tanh = float16_t_private::make_unary_function( [](float f){ return
// std::tanh(f); } ); constexpr inline auto asin = float16_t_private::make_unary_function( [](float
// f){ return std::asin(f); } ); constexpr inline auto asinh =
// float16_t_private::make_unary_function( [](float f){ return std::asinh(f); } ); constexpr inline
// auto acos = float16_t_private::make_unary_function( [](float f){ return std::acos(f); } );
// constexpr inline auto acosh = float16_t_private::make_unary_function( [](float f){ return
// std::acosh(f); } ); constexpr inline auto atan = float16_t_private::make_unary_function( [](float
// f){ return std::atan(f); } ); constexpr inline auto atanh =
// float16_t_private::make_unary_function( [](float f){ return std::atanh(f); } ); constexpr inline
// auto atan2 = float16_t_private::make_binary_function( [](float f1, float f2){ return
// std::atan2(f1, f2); } );

// constexpr inline auto erf = float16_t_private::make_unary_function( [](float f){ return
// std::erf(f); } ); constexpr inline auto erfc = float16_t_private::make_unary_function( [](float
// f){ return std::erfc(f); } ); constexpr inline auto tgamma =
// float16_t_private::make_unary_function( [](float f){ return std::tgamma(f); } ); constexpr inline
// auto lgamma = float16_t_private::make_unary_function( [](float f){ return std::lgamma(f); } );
// constexpr inline auto ceil = float16_t_private::make_unary_function( [](float f){ return
// std::ceil(f); } ); constexpr inline auto floor = float16_t_private::make_unary_function( [](float
// f){ return std::floor(f); } ); constexpr inline auto trunc =
// float16_t_private::make_unary_function( [](float f){ return std::trunc(f); } ); constexpr inline
// auto round = float16_t_private::make_unary_function( [](float f){ return std::round(f); } );
// constexpr inline auto nearbyint = float16_t_private::make_unary_function( [](float f){ return
// std::nearbyint(f); } ); constexpr inline auto rint = float16_t_private::make_unary_function(
// [](float f){ return std::rint(f); } );

// Floating point manipulation functions not defined
// frexp ldexp, modf, scalbn, ilogb

// constexpr inline auto logb = float16_t_private::make_unary_function( [](float f){ return
// std::logb(f); } ); constexpr inline auto nextafter = float16_t_private::make_binary_function(
// [](float f1, float f2){ return std::nextafter(f1, f2); } ); constexpr inline auto copysign =
// float16_t_private::make_binary_function( [](float f1, float f2){ return std::copysign(f1, f2); }
// );
...
constexpr inline auto beta =
    float16_t_private::make_binary_function([](float f1, float f2) { return std::beta(f1, f2); });
constexpr inline auto comp_ellint_1 =
    float16_t_private::make_unary_function([](float f) { return std::comp_ellint_1(f); });
constexpr inline auto comp_ellint_2 =
    float16_t_private::make_unary_function([](float f) { return std::comp_ellint_2(f); });
constexpr inline auto comp_ellint_3 = float16_t_private::make_binary_function(
    [](float f1, float f2) { return std::comp_ellint_3(f1, f2); });
constexpr inline auto cyl_bessel_i = float16_t_private::make_binary_function(
    [](float f1, float f2) { return std::cyl_bessel_i(f1, f2); });
constexpr inline auto cyl_bessel_j = float16_t_private::make_binary_function(
    [](float f1, float f2) { return std::cyl_bessel_j(f1, f2); });
constexpr inline auto cyl_bessel_k = float16_t_private::make_binary_function(
    [](float f1, float f2) { return std::cyl_bessel_k(f1, f2); });
constexpr inline auto cyl_neumann = float16_t_private::make_binary_function(
    [](float f1, float f2) { return std::cyl_neumann(f1, f2); });
constexpr inline auto ellint_1 = float16_t_private::make_binary_function(
    [](float f1, float f2) { return std::ellint_1(f1, f2); });
constexpr inline auto ellint_2 = float16_t_private::make_binary_function(
    [](float f1, float f2) { return std::ellint_2(f1, f2); });
constexpr inline auto ellint_3 = float16_t_private::make_trinary_function(
    [](float f1, float f2, float f3) { return std::ellint_3(f1, f2, f3); });
constexpr inline auto expint =
    float16_t_private::make_unary_function([](float f) { return std::expint(f); });
constexpr inline auto riemann_zeta =
...
template <>
struct numeric_limits<numeric::float16_t> {
  static constexpr bool is_specialized = true;
  static constexpr numeric::float16_t min() noexcept {
    return numeric::fp16_min_positive;
  }
  static constexpr numeric::float16_t max() noexcept {
    return numeric::fp16_max;
  }
  static constexpr numeric::float16_t lowest() noexcept {
    return numeric::fp16_min;
  }
  ...
  static constexpr numeric::float16_t epsilon() noexcept {
    return numeric::fp16_epsilon;
  }
  static constexpr numeric::float16_t round_error() noexcept {
    return numeric::fp16_half;
  }
  ...
  static constexpr numeric::float16_t infinity() noexcept {
    return numeric::fp16_infinity;
  }
  static constexpr numeric::float16_t quiet_NaN() noexcept {
    return numeric::fp16_nan;
  }
  static constexpr numeric::float16_t signaling_NaN() noexcept {
    return numeric::fp16_nan;
  }  // TODO: emit signal??
  static constexpr numeric::float16_t denorm_min() noexcept {
    return numeric::fp16_min_positive_subnormal;
  }
...
template <>
inline constexpr bool is_floating_point_v<numeric::float16_t> = true;
template <>
inline constexpr bool is_arithmetic_v<numeric::float16_t> = true;
template <>
inline constexpr bool is_signed_v<numeric::float16_t> = true;
